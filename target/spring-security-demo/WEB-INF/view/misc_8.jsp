...
Saurabh accidently used <br>
    sudo rm .* <br>
Now he is unable to fnd the files. So help him to recover his data from the flag.<br>
raw data : <a href="https://s3.amazonaws.com/ctf-data-files/rawdata.html">Link</a>     <br>
		</div>
	</div>
	<hr>
