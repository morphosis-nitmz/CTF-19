...
<div class = "container card question-card">
  <h2 class= "text-center">
       Government is tracking every activity of your social media,& browsing. They have access to every electronic device that has software so privacy is myth now. But you can't just stop using everything. So what would you do? </h2>
 </div> 
 <br>
 <br>
		</div>
