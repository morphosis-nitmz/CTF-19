...
<div class = "container card question-card">
  <h2 class= "text-center">
       What is the dimension of the cropped image? Add width and height of dimension and that will be your flag. Visit:  <a href="https://image-crop-react-node.herokuapp.com/">Link</a>
<br>Remember: Choose jpg/png/jpeg image, not other media files.<br>
 	         if an error occurs why choosing file just refreshes the page.
  </h2>
 </div> 
 <br>
 <br>
