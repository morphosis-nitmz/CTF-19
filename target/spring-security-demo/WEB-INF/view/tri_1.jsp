	...
	<div class="row">
      ...
      <%
         // sending the question id to the check_ans_of_que
 		 ...
 		 System.out.println("que id "+que_id);
    	 ...
    	 try{
    		 ...
    		 System.out.println("que hello2");
		    	  ...
		    	  while(rs.next()){
		    		  ...
		    		  //hint = rs.getString("hint");
		     		 System.out.println("que point  "+que_point);
...
<div class = "container card question-card">
  <h2 class= "text-center">
       Youtube Music Application's SSL issued by which organization, I want the full name ?  </h2>
 </div> 
 <br>
 <br>
		</div>
