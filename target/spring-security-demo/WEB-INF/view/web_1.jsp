...
<div class = "container card question-card">
  <h2 class= "text-center">
       I have to login again without clicking logout button but why?<br>
Refer: Login credentials [geekrk.01@gmail.com, 12345]<br>
           <a href="https://node-shop-ecommerce.herokuapp.com/">Link</a>
  </h2>
 </div> 
 <br>
 <br>
