 ...
 */
@WebServlet("/Door3")
public class Door3 extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			if (door.equals(ansDao)) {
				request.setAttribute("rghtAns1", "Correct Answer! Its your Flag");
				// response.sendRedirect("login.jsp");
				RequestDispatcher rd = request.getRequestDispatcher("/yhoooItsFlag");
