...
<div class = "container card question-card">
  <h2 class= "text-center">
      Check all the images and find the link between them.
finds the place name of existance.<br>
      <a href="https://s3.amazonaws.com/ctf-data-files/trivia/7_1.jpg">Image1</a> <br>
      <a href="https://s3.amazonaws.com/ctf-data-files/trivia/7_2.jpeg">Image2</a> <br>
      <a href="https://s3.amazonaws.com/ctf-data-files/trivia/7_3.jpeg">Image3</a> </h2>
 </div> 
 <br>
 <br>
		</div>
