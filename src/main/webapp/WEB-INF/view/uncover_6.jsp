...
Find the answer in a file. Check all folders.
 <a href="https://s3.amazonaws.com/ctf-data-files/folder/2.zip">Link</a> 
 <br>
 To open this you should know about "localhost". 
 <br>
		</div>
	</div>
	<hr>
