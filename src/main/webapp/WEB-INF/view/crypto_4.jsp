...
<div class = "container card question-card">
  ...
  <!-- 4bit shift  for every position and ring for every rotor -->
  Abhishek use Engima machine for encryption. Decrypt it. [rpbpg pydsn apqde vvns]  <br>
 <br>
		</div>
	</div>
	<hr>
